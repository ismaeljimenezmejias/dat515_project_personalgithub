...
func testDockerfileExists(t *testing.T, scoreDec func()) {
	...
	requiredFiles := map[string]string{
		"Task1_BasicWeb":   "my-web-app/Dockerfile",
		"Task2_Advanced":   "advanced-app/Dockerfile",
		"Task3_Optimized":  "optimized-app/Dockerfile",
		"Task4_Go":         "go-app/Dockerfile",
		"Task5_Production": "production-app/Dockerfile",
	}
